    ...
    <div class="box box-widget widget-user">
        <div class="widget-user-header bg-blue-active">
            <p style="text-align: center;">
                <span style="font-family: georgia, palatino; font-size: 15pt;">Selamat datang di Sistem Absensi Karyawan ANXIETIVE.</span>
            </p>
            <h3 class="widget-user-username"></h3>
            <h5 class="widget-user-desc"></h5>
        </div>
        <div class="widget-user-image">
            <img class="img-circle" src="<?php echo base_url() ?>assets/dist/img/anx.jpg" alt="User Avatar">
        </div>
        <div class="box-footer">
            <div class="row">
                ...
                <div class="col-sm-4 border-right">
                    ...
                    <center>
                        <i>Sistem Absensi Karyawan ANXIETIVE</i><br>
