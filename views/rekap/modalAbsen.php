    ...
    <div class="box-body">
        <div class="modal-content">
            <span id="print-area">
                    ...
                    <table style='margin-left:70px;'>
                        <tr>
                            <td style='padding:50px'>
                                <img src="<?php echo base_url(); ?>assets/dist/img/anx.jpg" width='100px'></img>
                            </td>
                            <td> <br>
                ...
                &nbsp;&nbsp;&nbsp;<b style="padding-left : 30px">POTONGAN GAJI TERLAMBAT :</b>&nbsp;&nbsp;&nbsp;
                <b style="padding-left : 30px"> 20.000 ATAU (MAKAN SIANG)</b>&nbsp;&nbsp;&nbsp;
        </div>
